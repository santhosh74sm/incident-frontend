                            ...
                            <div className="px-5 pb-6 sm:px-8 sm:pb-7">
                                {serverError && (
                                    <div className="mb-5 rounded-lg border border-rose-200 bg-rose-50 px-4 py-3 " role="alert" aria-live="polite">
                                        <div className="flex items-start gap-3">
                                            ...
                                            <div>
                                                <p className="text-sm font-semibold text-rose-800 ">Sign-in failed</p>
                                ...
                                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" noValidate aria-busy={submitting}>
                                    ...
                                    <div className="flex items-center justify-between gap-4">
                                        ...
                                        <span className="text-xs font-semibold text-blue-700 " title="Password resets are handled by the Super Admin.">
                                            Forgot password?
                                        </span>
                                    </div>
                                ...
                                <div className="mt-6 border-t border-slate-200 pt-5 ">
                                    <div className="flex items-center justify-between gap-4 text-sm">
                                        <p className="text-slate-500 ">New school?</p>
                                        <Link
                                            to="/register"
